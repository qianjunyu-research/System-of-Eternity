...
def traceability(run_rows: Sequence[Dict[str, object]]) -> List[Dict[str, object]]:
    ...
    return [
        ...
        },
        {
            ...
            "source": "C00/C04; v18",
            "output_columns": "hub_2_balanced,hub_3_balanced,hub_2_single_hub_failure,hub_3_single_hub_failure",
            "metric": "all_hub_delta;single_hub_delta",
            "value": f"{round(hub2_ignition - hub3_ignition, 6)};{round(hub2_single_ignition - hub3_single_ignition, 6)}",
            "status": "context_dependent" if hub2_single_ignition > hub3_single_ignition else "inconclusive",
        },
        {
            "claim_id": "CL06",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run SOE Grand Simulation v0.2 audit-response batch.")
