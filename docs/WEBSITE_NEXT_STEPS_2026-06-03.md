# Non-Terminal Research Website Next Steps
...
- Add full citation snippets or DOI metadata per publication.
- Add richer SOE diagrams once the visual diagram language is designed.
- Add a proper Writing page section after Substack has enough stable content to highlight.

## Focused Deep-Research Prompt

Use the live staging site, not only the file folder:
