...
- expert-class or epistemic capture;
- metrics gaming;
- jurisdictional arbitrage;
- consent or human-subject failure;
- supply-chain or infrastructure dependency;
- charismatic movement drift;
- nihilistic sabotage;
- economic starvation;
- schismatic forking;
- procedural entropy;
...
- treats AI hostile review as empirical proof of organizational resilience;
- treats multi-AI agreement as independent replication;
- assumes adversaries are honest;
- assumes adversaries are rational, competent, or capture-seeking;
...
Acceptance should also require that the package can produce ranked, concrete failure pathways rather than only abstract philosophical critique.
